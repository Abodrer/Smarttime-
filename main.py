...
async def dot_styles(event):
    if event.sender_id == settings["my_id"]:
        await event.respond(
            ...
            "<b>• <code>.افتراضي</code></b> - لا يوجد زخرفة. <i>مثال:</i> 12:12\n"
            "<b>• <code>.مزخرف1</code></b> - نمط الزخرفة الأول. <i>مثال:</i> 𝟏𝟐:𝟏𝟐\n"
            "<b>• <code>.عربي</code></b> - الأرقام العربية. <i>مثال:</i> ١٢:١٢\n"
            "<b>• <code>.مزخرف2</code></b> - نمط الزخرفة الثاني. <i>مثال:</i> ①②:①②\n",
            parse_mode="html"
        )
